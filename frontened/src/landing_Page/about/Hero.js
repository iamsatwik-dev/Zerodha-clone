    ...
    return ( 
        ...
        <div className='container '>
            ...
            <div className='row p-5 border-top mt-5 text-muted'>
                <div className='about col-5 mt-4 p-5'>
                ...
                <div className='about col-5 mt-4 p-5'>
                    ...
                    <p>
                    And yet, we are always up to something new every day. Catch up on the latest updates on ourspa <a href='#'>blog</a> or see what the media is <a href='#'>saying about us</a>.
                    </p>
                </div>
